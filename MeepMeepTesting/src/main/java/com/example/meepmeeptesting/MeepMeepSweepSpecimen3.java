...
public class MeepMeepSweepSpecimen3{
    ...
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(18, -60, -Math.PI / 2))
                ...
                //.waitSeconds(2)
                // sweep 2nd block
                .splineToSplineHeading(new Pose2d(56,-48,-Math.PI/4),-Math.PI/4)
                .splineToSplineHeading(new Pose2d(52,-36,Math.PI/3),Math.PI/3)
                // execute a small turn, hopefully sweeping the block a bit
                //.splineToSplineHeading(new Pose2d(52,-34,0),-Math.PI/3)
                //.waitSeconds(2)
                // heading back up to get third block THIS TAKES TOO LONG
                /*
                .splineToSplineHeading(new Pose2d(48,-36,-Math.PI/2),Math.PI/2)
                .splineToLinearHeading(new Pose2d(54,-12,Math.PI),0)
                .splineToSplineHeading(new Pose2d(68,-24,Math.PI/2),-Math.PI/2)
                        .setTangent(-Math.PI/2)
                .splineToLinearHeading(new Pose2d(40,-64,Math.PI/2),-Math.PI/2)
                 */
