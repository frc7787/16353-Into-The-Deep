...
public class BlueAuto extends LinearOpMode {
    ...
    private void move(DcMotor leftDrive,DcMotor rightDrive, DcMotor backLeftDrive, DcMotor backRightDrive,
        ...
        newBackLeftTarget = backLeftDrive.getCurrentPosition() + (int)((backLeftInches-ROBOT_LENGTH_INCH) * COUNTS_PER_INCH);
        newBackRightTarget = backRightDrive.getCurrentPosition() + (int)((backRightInches-ROBOT_LENGTH_INCH) * COUNTS_PER_INCH);
        ...
        runtime.reset();
        ((DcMotor)leftDrive).setPower(Math.abs(speed));
        ((DcMotor)rightDrive).setPower(Math.abs(speed));
        ((DcMotor)backLeftDrive).setPower(Math.abs(speed));
        ((DcMotor)backRightDrive).setPower(Math.abs(speed));
    ...
    public void runOpMode() {
        ...
        move(leftDrive,rightDrive,backLeftDrive,backRightDrive,2, leftInches-5,rightInches-5,leftInches-5,rightInches-5);
        move(leftDrive,rightDrive,backLeftDrive,backRightDrive,4, leftInches+15,rightInches+15,leftInches+15,rightInches+15);
