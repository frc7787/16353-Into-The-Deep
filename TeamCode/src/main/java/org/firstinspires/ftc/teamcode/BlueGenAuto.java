...
@Disabled
@Autonomous
public class BlueGenAuto extends LinearOpMode {
    ...
    static final double     COUNTS_PER_NEVEREST_REV    = 1440 ;    // eg: TETRIX Motor Encoder
    ...
    double timeoutS=600;
    //Specifies the itinerary
    int[] allDirections={1,3,1,4}; // Forward, Left, Forward, Right
    double[] allLeftInches={30.0,13.0,24.0,109.0};
    double[] allRightInches={30.0,13.0,24.0,109.0};
    double [] speed={0.6,0.6,0.6,0.6};
    ...
    public void runOpMode() {
        ...
        for (int i=0; i<allDirections.length; i++) {
            move(leftDrive,rightDrive,backLeftDrive,backRightDrive,allDirections[i], allLeftInches[i],
                    allRightInches[i],allLeftInches[i], allRightInches[i]);
        }
