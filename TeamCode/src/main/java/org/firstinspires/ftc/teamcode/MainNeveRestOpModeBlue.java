...
@TeleOp
public class MainNeveRestOpModeBlue extends LinearOpMode {
    ...
    */
    ...
    private void blinkinBlack() {
    }
    private void blinkinGreen() {
    }private void blinkinBlue() {
    }private void blinkinOrange() {
    }     private void blinkinRed() {
        baseLights.setPattern(RevBlinkinLedDriver.BlinkinPattern.BLUE);
    }
}
