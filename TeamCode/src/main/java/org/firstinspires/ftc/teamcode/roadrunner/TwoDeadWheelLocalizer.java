...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        // NEW testing calibration 1 Feb
        //public double parYTicks = 0.0; // y position of the parallel encoder (in tick units)
        //public double perpXTicks = 1400.0; // x position of the perpendicular encoder (in tick units)
        public double parYTicks = 1398.56; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1056.78; // x position of the perpendicular encoder (in tick units)
    }
